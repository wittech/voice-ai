    ...
    useEffect(() => {
      ...
      selectedFiles.forEach(y => {
        ctx.allFiles
          ...
          .forEach(x => {
            let cnt = new Content();
            let contentType = x.getFieldsMap().get('object')?.getStringValue();
            if (contentType) cnt.setContenttype(contentType);
            let name = x.getFieldsMap().get('title_str')?.getStringValue();
            ...
            <li className="m-1">
              <button
                ...
                onClick={() => {
                  ...
                  ctx.addCriteria('object', 'database', '=');
                }}
              >
                Databases
              </button>
