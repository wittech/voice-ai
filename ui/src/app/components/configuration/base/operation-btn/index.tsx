...
const iconMap = {
  ...
  edit: (
    ...
    >
      <path
        d="M6.99998 11.6666H12.25M1.75 11.6666H2.72682C3.01217 11.6666 3.15485 11.6666 3.28912 11.6344C3.40816 11.6058 3.52196 11.5587 3.62635 11.4947C3.74408 11.4226 3.84497 11.3217 4.04675 11.1199L11.375 3.79164C11.8583 3.30839 11.8583 2.52488 11.375 2.04164C10.8918 1.55839 10.1083 1.55839 9.62501 2.04164L2.29674 9.3699C2.09496 9.57168 1.99407 9.67257 1.92192 9.7903C1.85795 9.89469 1.81081 10.0085 1.78224 10.1275C1.75 10.2618 1.75 10.4045 1.75 10.6898V11.6666Z"
        stroke="#344054"
        strokeWidth="1.25"
        strokeLinecap="round"
...
const OperationBtn: FC<IOperationBtnProps> = ({
  ...
  return (
    <div
      className={cn(
        className,
        'flex items-center rounded-[2px] h-7 px-3 space-x-1cursor-pointer hover:bg-gray-200 select-none',
      )}
      onClick={onClick}
    >
