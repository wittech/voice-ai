              ...
              element: (
                <div className="flex-1 px-4 space-y-8">
                  <FieldSet className="col-span-2">
                    ...
                    <div className="flex items-center gap-2">
                      <code className="flex-1 dark:bg-gray-950 bg-gray-100 px-3 py-2 font-mono text-xs min-w-0 overflow-hidden">
                        {`${CONFIG.connection.media}/v1/talk/${props.deployment?.getPhoneprovidername().toLowerCase()}/call/${props.deployment.getAssistantid()}?x-api-key={{PROJECT_CRDENTIAL_KEY}}`}
                      </code>
                  ...
                  <FieldSet className="col-span-2">
                    ...
                    <div className="flex items-center gap-2">
                      <code className="flex-1 dark:bg-gray-950 bg-gray-100 px-3 py-2 font-mono text-xs min-w-0 overflow-hidden">
                        {`${CONFIG.connection.media}/v1/talk/${props.deployment?.getPhoneprovidername().toLowerCase()}/event/${props.deployment.getAssistantid()}?x-api-key={{PROJECT_CRDENTIAL_KEY}}`}
                      </code>
                      <div className="flex shrink-0 border divide-x">
                        <CopyButton className="h-7 w-7">
                          {`${CONFIG.connection.media}/v1/talk/${props.deployment?.getPhoneprovidername().toLowerCase()}/event/${props.deployment.getAssistantid()}?x-api-key={{PROJECT_CRDENTIAL_KEY}}`}
