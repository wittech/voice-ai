...
export const TableHeader: FC<
  TableHeaderProps & { isActionable?: boolean }
> = props => {
  return (
    <thead className="dark:bg-gray-950/30 bg-gray-200 ">
      <tr className="">
        ...
        {props.isActionable && (
          <th className="whitespace-no-wrap px-2 md:px-5 py-3">
...
export const TableHederWithCheckbox: FC<
  TableHeaderProps & { ontoggle: (boolean) => void }
> = memo(props => {
  return (
