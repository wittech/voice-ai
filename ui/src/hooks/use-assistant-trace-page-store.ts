import {
  AssistantTrace,
  AssistantTraceProperty,
} from '@/types/types.assistant-trace';
import {
  initialPaginated,
...
import { GetAllAssistantMessageResponse } from '@rapidaai/react';
import { GetAssistantMessages } from '@rapidaai/react';
import { connectionConfig } from '@/configs';
const initialState: AssistantTraceProperty = {
  /**
   *
   */
  assistantMessages: [],
 ...
 *
 */
export const useAssistantTracePageStore = create<AssistantTrace>(
  (set, get) => ({
    ...initialState,
    ...initialPaginated,
    ...
    getAssistantMessages(
      ...
      const afterGetAssistantMessages = (
        ...
        gur: GetAllAssistantMessageResponse | null,
      ) => {
        if (gur?.getSuccess()) {
          set({
