...
from app.services.search.channel_search import ChannelSearch


class TestChannelSearchQueryGeneration:
    ...
    async def test_channel_query(
        ...
        channel_search: ChannelSearch = ChannelSearch()
        content_type: str = "channel"
        generated_query: Mapping[str, Any] = channel_search.query(
