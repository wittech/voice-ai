...
func (r *AudioResampler) ConvertToFloat32(data []byte, config *AudioConfig) ([]float32, error) {
...
func (r *AudioResampler) ConvertToFloat32WithResample(data []byte, source *AudioConfig, targetSampleRate int) ([]float32, error) {
	...
	return r.ConvertToFloat32(resampledData, target)
}

// ConvertFromFloat32 converts float32 samples to byte audio data
func (r *AudioResampler) ConvertFromFloat32(samples []float32, config *AudioConfig) ([]byte, error) {
